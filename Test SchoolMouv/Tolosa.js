...
function trouverSaPlace(groupes) {
  ...
  if (ponctionPhilippe.includes(groupes[0] + 57)) {
    if (ponctionPhilippe.includes(groupes[0] + 57 + groupes[1])) {
      return 3
    } else if (ponctionAmed.includes(groupes[0] + 57 + groupes[1])) {
      return 3
    } else return 2
  } else if (ponctionAmed.includes(groupes[0] + 57)) {
    if (ponctionPhilippe.includes(groupes[0] + 57 + groupes[1])) {
      return 3
    } else if (ponctionAmed.includes(groupes[0] + 57 + groupes[1])) {
      return 3
